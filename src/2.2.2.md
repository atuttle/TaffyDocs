...
* **callback (function)** - _optional - A callback function that each data element will be passed through before being saved to the array._
...
The callback function can be used to transform data elements before they are added to the array. This function can be used to format the date fields in a particular style or change the case of the data elements. See the api_callback examples for an example of how this function can be used to change the format of the data fields.

	return representationOf( queryToArray(someQuery, someFunction) );
...
* **data (query)** - The query object to be transformed
* **callback (function)** - _optional - A callback function that each data element will be passed through before being saved to the structure._
...
The callback function can be used to transform data elements before they are added to the array. This function can be used to format the date fields in a particular style or change the case of the data elements. See the api_callback examples for an example of how this function can be used to change the format of the data fields.
	...
	return representationOf( queryToStruct(someQuery, someFunction) );
