...
You may want to log additional debugging information in the log adapters (in 'bonus'). From a resousure, you can call addDebugData(struct) to do this, passing in anything you like.
