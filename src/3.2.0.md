...
If you're after something a bit more complex, but still short of OAuth, I've written an article covering [Advanced Authentication with Taffy](https://adamtuttle.codes/advanced-authentication-with-taffy-apis/).
...
This is a convenience method used to make sure that certain all-numeric inputs get serialized as a string in the output not converted to numeric output.  Examples are postal codes or phone numbers.
	...
	return rep(queryToArray(myQuery, function(row){
