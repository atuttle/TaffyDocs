...
You may want to log additional contextual information when using exception log adapters (available in 'taffy/bonus'). Inside your Taffy resources you can call a new `addDebugData()` method that will be made available to logging adapters. It accepts a single argument of any type, and whatever data you pass will be made available to any log adapters you may be using.
...
#### Add `addDebugData` method \([#327](https://github.com/atuttle/Taffy/issues/327)\)

Adds a convenient way to make contextual information available to logging adapters for exception logging.
