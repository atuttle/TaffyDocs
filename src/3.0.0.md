...
<p style="border: 1px solid #970F0F; background: #FFD2D2; padding: 10px 15px; color: #970F0F;">Version 3.0.0 is currently in development. This page of documentation is in development along with the new release. There may be some broken links (release notes, downloads, etc) until the release is published, and content on this page is subject to change without notice.</p>

<a id="download" href="https://github.com/atuttle/Taffy/archive/v3.0.0-alpha.zip">Download Taffy 3.0.0-alpha.zip</a>
