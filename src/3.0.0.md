...
<p style="border: 1px solid #970F0F; background: #FFD2D2; padding: 10px 15px; color: #970F0F;">Version 3.0.0 is currently at release candidate phase. This page of documentation is in development along with the new release. There may be some broken links until the release is published, and content on this page is subject to change without notice.</p>

<a id="download" href="https://github.com/atuttle/Taffy/archive/v3.0.0-RC3.zip">Download Taffy 3.0.0-RC3.zip</a>
...
You know how Representation Classes abstract serialization of data from returning the data from your resources? Input Deserializers are the same thing, but for incomming data. You define a component that understands various textual-representations of data (say, XML, YAML, JSON, etc) and Taffy will use it to accept any of those data types as POST/PUT bodies, and pass the data on to your resources.
...
##### Fixed a bug in the dashboard on CF8 \([#232](https://github.com/atuttle/Taffy/issues/232)\)

Thanks to [Damon Miller](https://github.com/damonmiller) for the bug report and fixed code!
