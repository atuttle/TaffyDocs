...
**Description:** The CFC dot-notation path, or bean name, of the Deserializer that your API will use to interpret the request body sent by the client.
