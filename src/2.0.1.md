...
Best practice would be to keep Taffy _out of your web root_. As luck would have it, this is also the easiest install method. Instead of putting taffy in the web root, use a global mapping (set in the CF Administrator) pointing `/taffy` to wherever you have it saved.
